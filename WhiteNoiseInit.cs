...
namespace TheWhiteNoiseProject
{
    public class WhiteNoiseInit : ModInitializer
    {
        ...
        private static void OnInitCards()
        {
            ...
            {
                new CardOptions(1,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(2,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(3,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(4,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(5,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(6,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(7,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(8,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
                new CardOptions(9,CardOption.NoInventory, cardColorOptions: new CardColorOptions(Color.white, iconColor: HSVColors.White)),
