...
public class BehaviourAction_StigmaAnim_md5488 : BehaviourActionBase
{
        ...
        ref RencounterManager.ActionAfterBehaviour opponent)
    {
        ...
        var movingAction2 =
            new RencounterManager.MovingAction(ActionDetail.S14, CharMoveState.MoveForward, 30f, false, 0.9f);
        movingAction2.SetEffectTiming(EffectTiming.PRE, EffectTiming.PRE, EffectTiming.PRE);
        new RencounterManager.MovingAction(ActionDetail.S14, CharMoveState.Stop, 0.0f, delay: 0.1f).SetEffectTiming(
