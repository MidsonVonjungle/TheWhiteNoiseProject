...
public class BehaviourAction_BlackSilence_ShortSword_md5488 : BehaviourActionBase
{
      ...
      ref RencounterManager.ActionAfterBehaviour opponent)
    {
        ...
        RencounterManager.MovingAction movingAction2 = new RencounterManager.MovingAction(ActionDetail.S10, CharMoveState.MoveForward, 30f, false, 0.9f);
        ...
        new RencounterManager.MovingAction(ActionDetail.S7, CharMoveState.Stop, 0.0f, delay: 0.1f).SetEffectTiming(EffectTiming.NOT_PRINT, EffectTiming.NOT_PRINT, EffectTiming.NOT_PRINT);
