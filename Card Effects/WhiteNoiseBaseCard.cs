...
namespace TheWhiteNoiseProject.Card_Effects
{
    public class DiceCardSelfAbility_WhiteNoiseBaseCard_md5488 : DiceCardSelfAbilityBase
    {
        public override void OnUseCard()
        {
            ...
            {
                if (target.bufListDetail.GetActivatedBufList().Find(x => x is BattleUnitBuf_WhiteNoiseBuff_md5488) is BattleUnitBuf_WhiteNoiseBuff_md5488 buf)
                    buf.OnAddBuf(1);
                else
